...
@section('content')
    ...
    <form action="{{ route('departs.update', $depart->depart_no) }}" class="row g-3 needs-validation" method="post" novalidate>
        ...
        <div class="col-md-4">
            ...
            <input class="form-control" type="number" name="depart_no" id="depart_no" value="{{ $depart->depart_no }}" disabled>
        </div>

        <div class="col-md-4">
            <label class="form-label" for="dnombre">Nombre del Departamento</label>
            <input class="form-control" type="text" maxlength="20" name="dnombre" id="dnombre" value="{{ $depart->dnombre }}"
                required>
        </div>
        <div class="col-md-4">
            <label class="form-label" for="loc">Localizacion</label>
            <input class="form-control" type="text" maxlength="20" name="loc" id="loc" value="{{ $depart->loc }}" required>
        </div>
        <div class="col-md-12">
